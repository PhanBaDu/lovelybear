...
<div class="border rounded-lg overflow-hidden h-96">
    <img class="h-[70%] w-full object-cover" src="https://img.lazcdn.com/g/p/6806dd18f8aed18b6c3339b5d322e9d1.jpg_360x360q75.jpg_.webp" alt="test" />
    <div class="h-[30%] p-2 flex flex-col justify-between gap-1">
        <div class="overflow-hidden">
            <span class="text-sm line-clamp-2">
              Giày thể thao Giày thể thao Giày thể thao Giày thể thao Giày thể thao Giày thể thao
            </span>
        </div>
            ...
            <div class="flex items-center gap-1">
                ...
                <span class="text-primary font-semibold text-base">
                    120.000đ
                            ...
                            <button class="bg-primary text-white shadow-xs hover:bg-destructive/90 dark:bg-destructive/60 add button inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[6px] text-xs px-2 py-1 cursor-pointer">
