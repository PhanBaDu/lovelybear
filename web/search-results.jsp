      ...
      ">
            ...
            <div class="pt-24 px-5 w-full pb-32">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="mb-8">
                        <h1 class="text-xl font-bold text-background mb-4">
                        ...
                        %>
                            <p class="text-background text-sm">
                                Tìm thấy <span class="font-semibold text-background"><%= products.size() %></span> sản phẩm
                            </p>
                        <% } %>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                                    ...
                                    <% } else { %>
                                        <a href="product?id=<%= product.getId() %>" class="block h-full w-full">
                                            <div class="h-full w-full bg-muted flex items-center justify-center">
                                                <svg class="w-16 h-16 text-background" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        %>
                            ...
                            <div class="col-span-full text-center py-20">
                                <h3 class="text-lg font-bold text-background mb-3">Không tìm thấy sản phẩm</h3>
                                <p class="text-background mb-8 text-sm">
                                    <% if (request.getAttribute("searchTerm") != null && !((String) request.getAttribute("searchTerm")).isEmpty()) { %>
